...
- **Pay-as-you-go requests are refused, not sent bare.** For the slugs Gate
  serves pay-as-you-go, while the account is in that mode, the direct path
  answers 503 with an error saying to open Gate Connect: those tools send no
