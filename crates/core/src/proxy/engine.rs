...
async fn serve_pac(
    ...
    loop {
        ...
        tokio::spawn(async move {
            ...
            // Only the request target is of interest, and only to tell the two
            // routes apart. A partial read just misses the CRL path and serves
            // the PAC, which is the same answer this gave before it had two
