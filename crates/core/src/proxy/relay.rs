...
// Shared with the forwarder's relay listener, which applies the same path rules
// when it serves a request itself.
use gate_connect_paths::{has_dot_segment, split_leading_segment};
...
mod tests {
    ...
    fn a_dot_segment_is_refused_rather_than_silently_renormalized() {
        for path in [
            ...
            "/anthropic/v1/..\\..\\admin",
            "/__gate/t/codex/anthropic/v1/.%2E\\.%2e\\admin",
        ] {
