...
pub struct Preferences {
    ...
    /// that expired, a disconnect-on-quit that could not put a tool back, a quit
    /// that put tools back as promised. A plain quit that could not put a tool
    /// back says so regardless: it is the last word before the process is gone.
    ///
